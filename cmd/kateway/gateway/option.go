...
func ParseFlags() {
	...
	flag.BoolVar(&Options.PermitStandbySub, "standbysub", true, "permits sub threads exceed partitions")
	...
	flag.IntVar(&Options.MaxSubBatchSize, "maxbatch", 500, "max sub batch size")
